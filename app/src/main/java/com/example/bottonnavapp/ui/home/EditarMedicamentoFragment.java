...
public class EditarMedicamentoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button buttonCancelarEdicion = view.findViewById(R.id.buttonCancelarEdicion);
        Button buttonGuardarEdicion = view.findViewById(R.id.buttonNuevoMedEditar);
        Button buttonBorrarMed = view.findViewById(R.id.buttonBorrarMed);
